...
/**
 * bin_tr_ancestor - finds the lowest common ancestor of two nodes
				     ...
				     const binary_tree_t *second)
{
	...
	depth_first = bin_tr_depth(first);
	depth_second = bin_tr_depth(second);
...
/**
 * bin_tr_depth - measures the depth of a node in a binary tree
